...
builder.Services.AddDbContext<CarLeasingContext>(dbContextOptionsBuilder =>
{
    var connectionString = builder.Configuration.GetConnectionString("CarLeasingDb");
    dbContextOptionsBuilder.UseSqlServer(connectionString).UseSnakeCaseNamingConvention(CultureInfo.InvariantCulture);
});
builder.Services.AddScoped<ICarLeasingRepository, CarLeasingRepository>();
